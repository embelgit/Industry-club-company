...
import InfrastructureDetailList from './InfrastructureDetailList';
import {getGSTList} from '../../../service/AllDrowpdownAPI';
import {
  getInfrastructureDetails,
  postInfrastructureDetails,
...
const InfrastructureDetail = () => {
  ...
  return (
    <>
          ...
          <Formik
            ...
            onSubmit={async (values, {setSubmitting, resetForm}) => {
              try {
                ...
                // API call
                const result = await postInfrastructureDetails(postData);
      ...
      {showTable && <InfrastructureDetailList />}
    </>
  );
};
